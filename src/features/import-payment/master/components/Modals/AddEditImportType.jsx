...
function AddEditImportType({ handleClose, open, editData: accountTypeData, getData }) {
      ...
      >
        ...
        >
          <span style={{ fontSize: "24px", fontWeight: "bolder" }}>
            {accountTypeData ? "Edit Import Type" : "Add Import Type"}
          </span>
          <RxCross2
            onClick={handleClose}
            style={{
...
export default AddEditImportType;
