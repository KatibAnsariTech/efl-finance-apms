...
//   const [openDepartmentSelect, setOpenDepartmentSelect] = React.useState(false);
//   const [openScopeSelect, setOpenScopeSelect] = React.useState(false);
//   const [scopes, setScopes] = React.useState([]);
//   const [openTypeSelect, setOpenTypeSelect] = React.useState(false);
//   const [types, setTypes] = React.useState([]);
//   const [openImportTypeSelect, setOpenImportTypeSelect] = React.useState(false);
//   const [importTypes, setImportTypes] = React.useState([]);


//   React.useEffect(() => {
//     if (editData) {
//       setValue("department", editData.companyIds || []);
//       const currentUser = {
...
//     try {
//       const response = await userRequest.get("/imt/getMasters?key=Department", {
//         params: {
//           page: 1,
//           limit: 100,
//         },
//       });
//       const departmentData = response?.data?.data?.masters || response?.data?.data || [];
...
//     try {
//       const response = await userRequest.get("/imt/getMasters?key=Type", {
//         params: {
//           page: 1,
//           limit: 100,
//         },
//       });
//       const typeData = response?.data?.data?.masters || response?.data?.data || [];
//       setTypes(typeData);
//     } catch (error) {
...
//     try {
//       const response = await userRequest.get("/imt/getMasters?key=Scope", {
//         params: {
//           page: 1,
//           limit: 100,
//         },
//       });
//       const scopeData = response?.data?.data?.masters || response?.data?.data || [];
//       setScopes(scopeData);
//     }
//     catch (error) {
...
//     try {
//       const response = await userRequest.get("/imt/getMasters?key=ImportType", {
//         params: {
//           page: 1,
//           limit: 100,
//         },
//       });
//       const importTypeData = response?.data?.data?.masters || response?.data?.data || [];
...
//             <InputLabel id="department-label">Select Departments</InputLabel>
//             <Controller
//               name="department"
//               control={control}
//               defaultValue={[]}
...
//                   onOpen={() => setOpenDepartmentSelect(true)}
//                   onClose={() => setOpenDepartmentSelect(false)}
//                   value={field.value || []}
//                   onChange={(e) => {
...
//                       {selected.map((value) => {
//                         const department = departments.find((c) => c._id === value);
//                         const departmentLabel = department?.name || value;
//                         return (
//                           <Chip
//                             key={value}
...
//           <FormControl fullWidth>
//             <InputLabel id="department-label">Select Import Type</InputLabel>
//             <Controller
//               name="department"
//               control={control}
//               defaultValue={[]}
...
//           <FormControl fullWidth>
//             <InputLabel id="department-label">Select Type</InputLabel>
//             <Controller
//               name="department"
//               control={control}
//               defaultValue={[]}
...
//           <FormControl fullWidth>
//             <InputLabel id="department-label">Select Scope</InputLabel>
//             <Controller
//               name="scope"
//               control={control}
//               defaultValue={[]}
