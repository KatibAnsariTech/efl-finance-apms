...
function AddEditLocation({ handleClose, open, editData: accountTypeData, getData }) {
  ...
  React.useEffect(() => {
    if (accountTypeData) {
      setValue("scope", accountTypeData.scope || "");
    } else {
      reset();
    }
      ...
      >
        ...
        >
          <span style={{ fontSize: "24px", fontWeight: "bolder" }}>
            {accountTypeData ? "Edit Location" : "Add Location"}
          </span>
          <RxCross2
            onClick={handleClose}
            style={{
