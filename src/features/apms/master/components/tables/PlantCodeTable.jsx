...
export default function PlantCodeTable({ handleEdit, handleDelete, refreshTrigger, onDataUpdate }) {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await userRequest.get(
        `/imt/getMasters?key=plantCode&page=${paginationModel.page + 1}&limit=${paginationModel.pageSize
        }`
      );
