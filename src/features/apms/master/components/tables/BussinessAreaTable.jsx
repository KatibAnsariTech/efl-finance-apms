...
export default function BussinessAreaTable({ handleEdit, handleDelete, refreshTrigger }) {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await userRequest.get(
        `/apms/getMasters?key=bussinessArea&page=${paginationModel.page + 1}&limit=${
      ...
      showErrorMessage(error, "Error fetching Document Type data", swal);
    } finally {
      setLoading(false);
    }
  };
