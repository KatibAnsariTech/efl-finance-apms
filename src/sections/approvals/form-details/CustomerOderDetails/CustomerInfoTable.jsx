...
const CustomerInfoTable = ({ data }) => {
  const orderDetail = data?.formId?.otherData || {};
  const cfData = data?.formId?.otherData?.cfData || {};
  const formStatistics = data?.formId?.otherData?.formStatistics || {};
