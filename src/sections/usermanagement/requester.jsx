...
const RequesterTable = ({ data, loading, onEdit, onDelete }) => {
  return (
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ backgroundColor: "#f5f5f5" }}>
                ...
                <TableCell sx={{ fontWeight: "bold" }}>Requester Name</TableCell>
                <TableCell sx={{ fontWeight: "bold" }}>Requester Email</TableCell>
