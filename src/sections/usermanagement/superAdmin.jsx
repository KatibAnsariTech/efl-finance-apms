...
const SuperAdminTable = ({ data, loading, onEdit, onDelete }) => {
  return (
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ backgroundColor: "#f5f5f5" }}>
                ...
                <TableCell sx={{ fontWeight: "bold" }}>Super Admin Name</TableCell>
                <TableCell sx={{ fontWeight: "bold" }}>Super Admin Email</TableCell>
