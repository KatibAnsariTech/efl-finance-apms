...
function AddEditSalesOffice({
  ...
  useEffect(() => {
    if (editData) {
      ...
      // Support category as array of objects or single object
      let categoryIds = [];
      if (Array.isArray(editData.category)) {
        categoryIds = editData.category.map((item) =>
          typeof item === "object" ? item._id : item
        );
      } else if (editData.category && typeof editData.category === "object") {
        categoryIds = [editData.category._id];
      } else if (editData.category) {
        categoryIds = [editData.category];
      }
...
export default AddEditSalesOffice;
